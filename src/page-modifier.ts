...
export default async (ctx: Koa.BaseContext): Promise<void> => {
    ...
    $(`
        <span class='header-info-container'>
            ...
            <div class='header-part server-info server-info-version'>
                <strong class='server-info-label'>version: </strong> 1.21<span style='color:#979797'>.5</span></div>
        </span>
    `).appendTo(newHeader);
    ...
    $(
        `<div>
            <p>UltraVanilla is a small-scale LGBT-friendly community Minecraft survival server with minimal enhancements to the core game. Everything is built in survival. 30 player slots is a sweetspot for a server that is not crowded or discouraging production. Community Projects are suggested and discussed on the discord, anyone is free to contribute! The server usually updates fast, and is currently running on Paper 1.21.5. No resets!</p>
        ...
        if (loaded)
            $(`
                <div class="tools-buttons">
                    ...
                    <button class="tools-button tools-jump-to-old-spawn" data-toggle="jump-to-old-spawn">Jump to Season 1 Spawn</button>
                    <button class="tools-button tools-jump-to-new-spawn" data-toggle="jump-to-new-spawn">Jump to Season 2 Spawn</button>
                    <button class="tools-button tools-jump-to-outpost" data-toggle="jump-to-outpost">Jump to Season 3 Outpost</button>
                    <button class="tools-button tools-jump-to-spawn" data-toggle="jump-to-spawn">Jump to Season 4 Spawn</button>
                    <div class="toggles">
    ...
    $("meta[name='description']").attr(
        "content",
        "UltraVanilla is a small-scale LGBT-friendly community Minecraft vanilla survival server with minimal enhancements to the core game. Everything is built in survival. 30 player slots is a sweetspot for a server that is not crowded or discouraging production. Community Projects are suggested and discussed on the discord, anyone is free to contribute! The server usually updates fast, and is currently running on Paper 1.21.5. No resets!",
    );
