...
export default async (ctx: Koa.BaseContext): Promise<void> => {
    ...
    $(`
        <span class='header-info-container'>
            ...
            <div class='header-part server-info server-info-version'>
                <strong class='server-info-label'>version: </strong> 1.21<span style='color:#979797'>.7</span></div>
        </span>
    `).appendTo(newHeader);
    ...
    $(
        `<div>
            <p>UltraVanilla is a small-scale LGBT-friendly community Minecraft survival server with minimal enhancements to the core game. Everything is built in survival. 30 player slots is a sweetspot for a server that is not crowded or discouraging production. Community Projects are suggested and discussed on the discord, anyone is free to contribute! The server usually updates fast, and is currently running on Paper 1.21.7. No resets!</p>
    ...
    $("meta[name='description']").attr(
        "content",
        "UltraVanilla is a small-scale LGBT-friendly community Minecraft vanilla survival server with minimal enhancements to the core game. Everything is built in survival. 30 player slots is a sweetspot for a server that is not crowded or discouraging production. Community Projects are suggested and discussed on the discord, anyone is free to contribute! The server usually updates fast, and is currently running on Paper 1.21.7. No resets!",
    );
